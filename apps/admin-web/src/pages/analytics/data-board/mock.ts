  ...
  periods: {
    ...
    monthly: {
      ...
      ageDistribution: {
        ...
        total: 1000,
        items: [
          { label: "50岁以下", value: 120, color: "#78d6d3", highlightColor: "#b8f4ed" },
          { label: "50-60岁", value: 260, color: "#80c9f5", highlightColor: "#c7e8ff" },
          { label: "60-70岁", value: 140, color: "#82d8ae", highlightColor: "#c4f3d6" },
          { label: "70-80岁", value: 210, color: "#ff9caf", highlightColor: "#ffd1dc" },
          { label: "80岁以上", value: 270, color: "#bba3ee", highlightColor: "#ded1ff" },
        ],
      },
      genderDistribution: {
        title: "用户性别构成",
        total: 1000,
        items: [
          { label: "男", value: 512, color: "#91e2b2", highlightColor: "#a8edea" },
          { label: "女", value: 488, color: "#ffb6b8", highlightColor: "#fed6e3" },
        ],
      },
    },
  },
