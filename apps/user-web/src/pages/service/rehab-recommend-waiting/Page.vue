...
import { getRehabRecommendWaitMs } from "./recommendation";
...
function updateProgress() {
  const waitMs = getRehabRecommendWaitMs();
...
function goToRecommendation() {
  progress.value = 100;
  props.navigation.redirectTo("service/rehab-recommend");
}
