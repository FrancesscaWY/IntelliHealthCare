...
import { getHomeExamRecommendWaitMs } from "./recommendation";
...
function updateProgress() {
  const waitMs = getHomeExamRecommendWaitMs();
...
function goToRecommendation() {
  progress.value = 100;
  props.navigation.redirectTo("service/home-exam-recommend");
}
...
onMounted(() => {
  ...
  void Promise.allSettled([
    prepareAiServiceScene("home-exam"),
...
<template>
  <section class="recommend-waiting-page">
