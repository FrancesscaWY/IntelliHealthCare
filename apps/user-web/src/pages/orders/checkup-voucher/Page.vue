...
const qrCells = new Set([
  ...
  28, 30, 32, 34, 36, 38, 40, 42, 44, 48, 49, 50, 51, 52, 53,
  54, 60, 63, 64, 67, 70, 72, 76, 78, 81, 83, 85, 88, 90, 91,
  94, 97, 100, 102, 105, 108, 110, 111, 114, 117, 119, 121, 124,
  126, 128, 129, 132, 134, 137, 140, 142, 145, 147, 149, 152,
  154, 155, 158, 160, 162, 165, 168, 170, 173, 176, 178, 180,
  181, 184, 187, 190, 192, 194, 197, 200, 202, 205, 207, 209,
  212, 214, 216, 219, 220, 221, 224,
]);

const codeGroups = mock.code.split("-");
  ...
  <section class="voucher-page">
    ...
    <main class="voucher-scroll">
      <section class="service-card">
        ...
        <h2>{{ mock.serviceName }}</h2>
        <div class="meta-row">
          <span>服务时间</span>
          <p>{{ mock.serviceTime }}</p>
        </div>
        <div class="meta-row">
          <span>服务地址</span>
          <p>{{ mock.address }}</p>
...
.code-card {
  border-radius: 18px;
  background: #f8fbfc;
  box-shadow: 0 12px 30px rgba(70, 110, 140, 0.08);
}
...
.meta-row {
  ...
  gap: 6px;
  padding: 13px 0;
  border-top: 1px solid rgba(120, 146, 166, 0.16);
}
...
.qr-shell {
  ...
  border-radius: 18px;
  background: #ffffff;
  box-shadow: 0 16px 34px rgba(60, 106, 139, 0.12);
}
